...
import "./DoubleSticker.css";

export default function DoubleSticker() {
  ...
  const getBarcodeData = async () => {
    ...
    let barcodeHtml = document.getElementsByClassName("sticker-container");
    barcodeHtml[0].innerHTML = currentState.stickerHtml;
  };
  ...
  return <div className="sticker-container"></div>;
}